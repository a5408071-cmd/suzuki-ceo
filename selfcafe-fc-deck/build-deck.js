...
/* =============================================================== p.17 モニタリング＆サポート */
{
  ...
  const items = [
    ...
    ["LuVideo", "6台以上のカメラで常時監視", "店内の状況を常時把握。異常があれば即座に確認・対応できる体制を整えています。"],
...
/* =============================================================== p.22 FAQ */
{
  ...
  const qa = [
    ...
    ["集客はどうすれば？", "数々のメディア取材や、本部によるSEO・MEO・AIO（LLMO）対策をはじめとしたWebマーケティングによって集客を支援します。"],
  ];
...
/* =============================================================== p.23 万全のサポート体制 */
{
  ...
  const cols = [
    ...
    ["LuLifeBuoy", "開業後サポート", ["店舗運営相談", "マシンの定期メンテナンス", "WEBサイト作成／更新", "SEO・MEO・AIO（LLMO）対策", "プレスリリース・Google MAP運用", "改修工事サポート"]],
  ];
